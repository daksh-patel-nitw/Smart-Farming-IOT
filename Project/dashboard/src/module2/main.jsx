...
const arr = [["Temperature", "temperature"], ["Ph", "ph"], ["Humidity", "humidity"], ["Moisture", "moisture"]]
export default function Main({ message, point, chngPoint, data }) {
  ...
  const msgs = {
    ...
    moisture: "Releasing water, low moisture detected.",
    humidity: "Releasing water, low humidity detected",
          ...
          <Card className="Bg1" style={{ height: '100%' }}>
            <CardContent>
              ...
              <Grid item container spacing={2}>
                ...
                <Grid item xs={6}>
                  <Button onClick={() => sendSignal("moisture",1)} variant="contained" color="primary" fullWidth>
                    Stabilize Moisture
                  </Button>
                </Grid>
                <Grid item xs={6}>
                ...
                <Grid item xs={6}>
                  <Button onClick={() => sendSignal("humidity",1)} variant="contained" color="primary" fullWidth>
                    Humidity Stabilizer
                  </Button>
                </Grid>
              </Grid>
